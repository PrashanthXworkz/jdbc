...
public class Santury {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Query query=entitymanager.createQuery("UPDATE BirdEntity entity SET entity.wingspan=:updateBywings  where entity.name=:updateByname");
			query.setParameter("updateBywings",50);
